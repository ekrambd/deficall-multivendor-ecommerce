                        ...
                        <div class="tab-content mb-6">
                            ...
                            <div class="tab-pane mb-4" id="account-orders">
                                ...
                                <table class="shop-table account-orders-table mb-6">
                                    ...
                                    @foreach($data as $row)
                                        <tr>
                                            <td class="order-id">#{{$row->invoice_no}}</td>
                                            <td class="order-date">{{$row->date}}</td>
                                            <td class="order-status">{{$row->time}}</td>
                            ...
                            <div class="tab-pane" id="account-details">
                                ...
                                <form class="form account-details-form" action="{{url('/user-profile-update')}}" method="post">
                                 @csrf
                                    ...
                                    <div class="form-group mb-6">
                                        ...
                                        <input type="email" id="email_1" name="email_1"
                                            class="form-control form-control-md" value="{{Auth::user()->email}}" readonly="">
                                    </div>
