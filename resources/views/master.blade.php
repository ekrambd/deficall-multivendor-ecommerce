...
<head>
    ...
    <title>DeFi - Ecommerce</title>

    <meta name="keywords" content="DeFi ecommerce website" />
    <meta name="description"
        content="DeFi ecommerce website Description">
    <meta name="author" content="DefiCall">

    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{asset('logo-icons/final_logo.png')}}">
...
<body class="home">
    <div class="page-wrapper">
        <h1 class="d-none">DeFiCall Ecommerce - Responsive Marketplace HTML Template</h1>
        
        <!-- Start of Header -->
        @if(Route::currentRouteName() == 'home')
         @include('header_nav.home')
        @else
         @include('header_nav.other_page')
        @endif
            ...
            <div class="container">
                ...
                <div class="footer-bottom">
                    <div class="footer-left">
                        <p class="copyright">Copyright © {{date('Y')}} Defi eCommerce Store. All Rights Reserved.</p>
                    </div>
    ...
    <script>
      $(document).ready(function(){
      	$(document).on('click','.current-value',function(e){
      		e.preventDefault();
      		let val = $(this).text();
      		let dataID = $(this).data('id');
      		$('#selected-currency').html(val);
      		let redirectUrl = "{{url('/set-currency')}}/"+dataID;
